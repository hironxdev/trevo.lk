...
import { Calendar, Car, Search, User, CalendarDays, Clock, Home, Users, MapPin, Sparkles, ShoppingCart } from "lucide-react"
...
const rentalTypes = [
  { value: "ALL", label: "All Rentals", icon: null },
  { value: "SHORT_TERM", label: "Short-term", icon: Clock },
  { value: "LONG_TERM", label: "Long-term", icon: CalendarDays },
]
...
export function HeroSearch() {
  ...
  useEffect(() => {
    if (isLoaded && preferredLocation?.city && !location) {
      setLocation(preferredLocation.city)
      setStaysLocation(preferredLocation.city)
    }
  }, [isLoaded, preferredLocation, location])
  ...
  const handleVehicleSearch = () => {
    ...
    if (vehicleType && vehicleType !== "ALL") params.set("type", vehicleType)
    if (withDriver && withDriver !== "ALL") params.set("withDriver", withDriver)
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="vehicles">
                      ...
                      <div className="col-span-2">
                        ...
                        <Popover>
                          <PopoverTrigger asChild>
                            <Button
                              variant="outline"
                              className="w-full h-12 px-4 justify-start bg-muted/50 border-0 hover:bg-muted font-medium"
                            >
                ...
                <div className="md:hidden">
                  <div className="bg-white/90 backdrop-blur-md border border-border/50 rounded-2xl shadow-xl shadow-primary/5 p-4 space-y-4">
                      ...
                      <div>
                        ...
                        <Popover>
                          <PopoverTrigger asChild>
                            <Button
                              variant="outline"
                              className="w-full h-12 px-3 justify-start bg-muted/50 border-0 font-medium"
                            >
                    ...
                    <Button 
                      onClick={handleVehicleSearch} 
                      className="w-full h-12 bg-primary hover:bg-primary/90 shadow-lg shadow-primary/25 text-base font-semibold"
                    >
              ...
              <TabsContent value="stays">
                ...
                <div className="md:hidden">
                  <div className="bg-white/90 backdrop-blur-md border border-border/50 rounded-2xl shadow-xl shadow-primary/5 p-4 space-y-4">
                    <div>
                      <label className="text-xs font-semibold text-foreground mb-2 block">Where are you going?</label>
                      <LocationSelector
                        value={staysLocation}
                        onChange={setStaysLocation}
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="text-xs font-semibold text-foreground mb-2 block">Check-in</label>
                        <Popover>
                          <PopoverTrigger asChild>
                            <Button
                              variant="outline"
                      ...
                      <div>
                        <label className="text-xs font-semibold text-foreground mb-2 block">Check-out</label>
                        <Popover>
                          <PopoverTrigger asChild>
                            <Button
                              variant="outline"
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="text-xs font-semibold text-foreground mb-2 block">Guests</label>
                        <div className="relative">
                          ...
                          <Input
                            ...
                            value={guests}
                            onChange={(e) => setGuests(Number(e.target.value) || 1)}
                            className="h-12 pl-10 bg-muted/50 border-0"
                          />
                        </div>
                      </div>

                      <div>
                        <label className="text-xs font-semibold text-foreground mb-2 block">Property</label>
                        <Select value={propertyType} onValueChange={setPropertyType}>
                          <SelectTrigger className="h-12 bg-muted/50 border-0">
                            <SelectValue placeholder="Type" />
                          </SelectTrigger>
              ...
              <TabsContent value="events">
                <div className="bg-white/80 backdrop-blur-md border border-border/50 rounded-2xl shadow-xl shadow-primary/5 p-8 text-center">
                  <div className="max-w-md mx-auto">
                    ...
                    <h3 className="text-xl font-semibold text-foreground mb-2">Events Coming Soon</h3>
                    <p className="text-muted-foreground mb-6">
                      Discover and book tickets for concerts, festivals, sports events, and more across Sri Lanka.
                    </p>
  ...
  <div className="bg-white/80 backdrop-blur-md border border-border/50 rounded-2xl shadow-xl shadow-primary/5 p-8 text-center">
    <div className="max-w-md mx-auto">
      ...
      <p className="text-muted-foreground mb-6">
        You are being redirected to our marketplace.
      </p>
      <Button
